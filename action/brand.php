...
class brand {
    ...
    function getBrand() {
        ...
        try {
            if ($id != null) {
                self::$data['data'] = BrandDAL::getOne($id);
            } else {
                self::$data['data'] = null;
            }
            self::$data['class'] = $this->class;
    ...
    function updateBrand() {
        ...
        try {
            if ($id != null) {
                ...
                self::$data = BrandDAL::update($id, $data);
            } else {
                if (BrandDAL::getByName($_POST['name'])) {
                ...
                self::$data = BrandDAL::insert($data);
            }
            if (self::$data) {
