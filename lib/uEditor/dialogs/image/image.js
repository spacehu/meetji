...
(function () {
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            if (!WebUploader.Uploader.support()) {
                ...
                console.log("editor.getOpt() error");
                return;
            }
    ...
    OnlineImage.prototype = {
        ...
        initContainer: function () {
            ...
            this.input.setAttribute('id', 'searchkeywords');
        ...
        initEvents: function () {
            ...
            domUtils.on(this.container, 'click', function (e) {
                ...
                if(e.target.type=='button'){
                    ...
                    var keywords=$G("searchkeywords").value;
                    console.log(keywords);
                    _this.initContainer();
                    _this.state = 0;
                    _this.listSize = editor.getOpt('imageManagerListSize');
                    _this.currentPage=1;
                    _this.pagesize=20;
                    _this.listEnd = false;
        ...
        getImageData: function () {
            ...
            if(!_this.listEnd && !this.isLoadingData) {
                ...
                var url='index.php?a=material&m=getIndexList',
                ...
                ajax.request(url, {
                    ...
                    'onsuccess': function (r) {
                        console.log(utils,_this.currentPage);
                        try {
                            var json = isJsonp ? r:eval('(' + r.responseText + ')');
                            if (json.data) {
                                _this.pushData(json.data);
                                if(_this.pagesize*_this.currentPage >= json.total) {
                                    _this.listEnd = true;
                                }
                                _this.currentPage++;
        ...
        pushData: function (list) {
            ...
            for (i = 0; i < list.length; i++) {
                if(list[i] && list[i].original_src) {
                    ...
                    img.width = 113;
                    img.setAttribute('src', urlPrefix +'https://api.tigerhuclub.com'+ list[i].original_src);
                    img.setAttribute('_src', urlPrefix +'https://api.tigerhuclub.com'+ list[i].original_src);
                    img.setAttribute('data-name', list[i].name);
